...
'''
This script scrapes data on Hermes bags form fashionhpile and writes to a CSV file
...
Scraping info on all Hermes bags from Fashionphile
'''
...
for i in range(1,5): #Loops over different overview pages 'hermes bag' - currently 4 pages
    pagenr = str(i)
    urlpage = 'https://www.fashionphile.com/shop/categories/handbag-styles/?brands=hermes&pageSize=180&sort=date-desc&page='+pagenr
    print(urlpage)
...
with open('FP_Hermes.csv','w', newline='') as f_output:
