...
'''
Scrapes all overview pages in a loop for CHANEL bags - 23 pages currently
'''
...
for i in range(1,8): #CONCAT
    pagenr = str(i)
    urlpage = 'https://shop.rebag.com/collections/Chanel/?page='+pagenr
    print(urlpage)
    ...
    for i in range(len(results)):
        ...
        model = getcontentout('Chanel Model: ',' Exterior Material:')  #change for other designers!
...
with open('rebag_chanel1.csv','w', newline='') as f_output:
