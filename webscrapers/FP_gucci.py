...
'''
This script scrapes data on Gucci bags form fashionhpile and writes to a CSV file
...
Scraping info on all Gucci bags from Fashionphile
'''
...
for i in range(1,6): #Loops over different overview pages 'CHANEL bag' - currently 7 pages
    pagenr = str(i)
    urlpage = 'https://www.fashionphile.com/shop/categories/handbag-styles/?brands=gucci&pageSize=180&sort=date-desc&page='+pagenr
    print(urlpage)
...
with open('FP_Gucci.csv','w', newline='') as f_output:
