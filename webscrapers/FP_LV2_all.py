...
'''
This script scrapes data on LV bags (pg 1-7) form fashionhpile and writes to a CSV file
...
Scraping info on all LV bags from Fashionphile (pg 1-7)
'''
...
for i in range(1,8): #Loops over different overview pages 'LV bag' - currently 7 pages
    pagenr = str(i)
...
with open('FP_LV_Allbags1to7.csv','w', newline='') as f_output:
