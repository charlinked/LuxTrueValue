...
'''
This script scrapes data on CHANEL bags form fashionhpile and writes to a CSV file
...
Scraping info on all CHANEL bags from Fashionphile
'''
...
for i in range(1,8): #Loops over different overview pages 'CHANEL bag' - currently 7 pages
    pagenr = str(i)
    urlpage = 'https://www.fashionphile.com/shop/categories/handbag-styles/?brands=chanel&pageSize=180&sort=date-desc&page='+pagenr
    print(urlpage)
...
with open('FPChanelbags.csv','w', newline='') as f_output:
